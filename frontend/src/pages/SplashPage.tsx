  ...
  return (
    <div className="bg-[#FDFCF5] min-h-screen flex flex-col items-center px-6 py-12">
      ...
      <p className="mt-4 max-w-2xl text-center text-lg text-gray-700">
        Take control of your pantry and reduce food waste. This app helps you
        track your groceries, get personalized recipes, and shop smarter — all
        at once!
      </p>
      ...
      <div className="flex justify-center gap-4 my-6">
        <Link
          className="bg-lime-600 hover:bg-lime-700 text-white font-semibold px-6 py-3 rounded-2xl"
          to="/login"
        >
          Login
        </Link>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl text-center">
        ...
        <div>
          ...
          <p className="text-gray-700 mt-2">
            Real-time pantry tracking, recipe recommendations, and shopping
            lists
          </p>
        </div>
      </div>
      ...
      <div className="mt-16 max-w-4xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-center text-sm">
          ...
          <div>
            ...
            <br />
            <span className="text-gray-600">
              Stay informed before food wastes
            </span>
          </div>
          <div>
          ...
          <div>
            ...
            <br />
            <span className="text-gray-600">
              Plan grocery trips efficiently
            </span>
          </div>
        </div>
      </div>
